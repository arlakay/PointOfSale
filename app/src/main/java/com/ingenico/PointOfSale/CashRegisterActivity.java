...
public class CashRegisterActivity extends CommonActivity implements
    ...
    private TextView textViewSubTotal, textViewCartVatTotal, textViewDiscount, textViewLayoutBillTotalAmount, textViewPaymentType,
            ...
            textViewCategories, textViewCartTotalAmountTotal, textViewCartSaveOrder, textViewService, textViewCartAddDiscount,
            ...
            textViewCartPrintBill;
    private Button buttonNext, buttonConnectToIcmpCommendSale, buttonRedeem;
...
//        userInterface.toggleHideyBar();
        ...
        textViewCartSaveOrder = (TextView)findViewById(R.id.textViewCartSaveOrder);
        ...
        textViewCartPrintBill = (TextView)findViewById(R.id.textViewCartPrintBill);
...
//        ));
        ...
        gridViewItemFromCategory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if (categoryValue!=null){
                    String variant = ArrayListItemNew.get(position).get(KEY_ITEM_VARIANT);
                    String modifierGroup = ArrayListItemNew.get(position).get(KEY_ITEM_MODIFIER_GROUP);
        ...
        textViewCartAddDiscount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialogAddDiscount.setTransaction_id(sessionManager.getTansactionID());
...
//    }
    ...
    public void generateViewCart (String transaction_id,
        ...
        if (realm_results_transaction_detail.size()!=0){
            ...
            }else {textViewCartTableNumber.setVisibility(View.INVISIBLE);}
            ...
            for (int i = 0; i < realmResultTransactionDetail.size(); i++) {
                ...
                if (realmResultTransactionDetail.get(i).getTransactionDetailItemID().contains("item")){
                    ...
                    for (int j = 0; j < realmListTransactionDetailModifier.size(); j++) {
                        // this variable help us to validate the string inside the realm list
                        // because null realm list is unreadable
            ...
            Log.e("test",linkedListTransactionDetailPremier+"");
    ...
    private boolean isLastItem (Realm realm, String item_id, String total_price){
        ...
        if (realmResultTransactionDetail.size() > 0) {
            ...
            value = item_id.equals(transactionDetail.getTransactionDetailItemID()) && sessionManager.getTansactionID().equals(transactionDetail.getTransactionDetailID());
        }else {
            value = false;
        }
    ...
    private void saveTransactionToDatabase (Realm realm, String transaction_id, String user_id,
                                            String cashier_name,
    ...
    private void prepareSaveOrderData (Realm realm, String totalTable){
        ...
        }else {logger.addError("Save Order Database","already exist");}
    }
...
//        }
    ...
    public void deleteItemFromCart(String item_id, String variant_id){
        ...
        logger.addInfo("testing","transactionDetailAllItem " + realmResultsTransDetail.size());
    }
