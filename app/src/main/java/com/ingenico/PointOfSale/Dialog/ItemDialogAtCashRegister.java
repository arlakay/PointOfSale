...
public class ItemDialogAtCashRegister extends DialogFragment {
    ...
    public ItemDialogAtCashRegister setTransaction_id(String t_id){this.transaction_id = t_id;return this;}
    public ItemDialogAtCashRegister setItem_id(String id){this.item_id = id;return this;}
    public ItemDialogAtCashRegister setItem_name(String item_name) {this.item_name = item_name;return this;}
    public ItemDialogAtCashRegister setItem_price(String item_price) {this.item_price = item_price;return this;}
    public ItemDialogAtCashRegister setItem_discount(String item_discount) {this.item_discount = item_discount;return this;}
    public ItemDialogAtCashRegister setItem_category(String item_category) {this.item_category = item_category;return this;}
    public ItemDialogAtCashRegister setItem_status_tax(String item_status_tax) {this.item_status_tax = item_status_tax;return this;}
    public ItemDialogAtCashRegister setItem_variant(String item_variant) {this.item_variant = item_variant;return this;}
    public ItemDialogAtCashRegister setItem_modifier_group(String item_modifier_group) {this.item_modifier_group = item_modifier_group;return this;}
    public ItemDialogAtCashRegister setFromCart(boolean itemFromCart){this.fromCart = itemFromCart;return this;}
