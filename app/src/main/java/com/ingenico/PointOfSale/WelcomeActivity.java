...
public class WelcomeActivity extends CommonActivity implements OnClickListener, OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPclUtil = new PclUtilities(this, "com.ingenico.PointOfSale", "pairing_addr.txt");
		/*
	...
	protected void onResume() {
		...
		if (isCompanionConnected())
        {
			...
			sessionManager.setAlreadyConnected("true");
        }
        else
        {
        	...
        	mtvState.setTextColor(Color.BLACK);
			sessionManager.setAlreadyConnected("false");
        }
		super.onResume();
	}
